...
extension NSLayoutConstraint {
    ...
    func isSpacing(itemView: UIView, attribute: NSLayoutConstraint.Attribute) -> Bool {
        return (firstItem as? UIView == itemView && firstAttribute == attribute)
            || (secondItem as? UIView == itemView && secondAttribute == attribute)
    }
    
    func isEqual(itemView: UIView, attribute: NSLayoutConstraint.Attribute) -> Bool {
